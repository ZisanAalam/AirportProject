...
def user_profile(request):
    return render(request, 'account/profile/profile.html', {'name': request.user.first_name})
...
#     return render(request, 'account/profile/addprofile.html', {'form': u_fm})
...
def user_profile_edit(request):
    ...
    if request.method == 'POST':
        ...
        u_fm = EditUserForm(instance=request.user)
    return render(request, 'account/profile/editprofile.html', {'u_form': u_fm})